...
part of 'repository_search_state.dart';
...
mixin _$RepositorySearchState {
  ...
  /// Create a copy of RepositorySearchState
...
class _$RepositorySearchStateImpl implements _RepositorySearchState {
  ...
  @override
  String toString() {
    return 'RepositorySearchState(repositories: $repositories, isLoading: $isLoading, errorMessage: $errorMessage, currentPage: $currentPage, hasReachedMax: $hasReachedMax)';
  }
...
abstract class _RepositorySearchState implements RepositorySearchState {
  const factory _RepositorySearchState(
      ...
      final String? errorMessage,
      final int currentPage,
      final bool hasReachedMax}) = _$RepositorySearchStateImpl;
